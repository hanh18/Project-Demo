...
function convertCover(name, sold, price, discount){
    // return '<div class="cover"><div class="product-name">' + name + '</div>' + evaluate() + '</div>';
...
var content = convertImg(productList[0].img) + convertCover(productList[0].productName, productList[0].sold, productList[0].price, productList[0].discount);
